...
class Application:
    ...
    @staticmethod
    def _demande_type_recommandation():
        choix_type_recommandation = input('Choisis le type de recommandation que tu souhaites ajouter ?'
                                          '\n\tPour une musique, entre 1'
                                          '\n\tPour un film ou une série, entre 2'
                                          '\n\tPour un livre, entre 3'
                                          '\n\tPour annuler la saisie, entre 0'
                                          '\n\tC\'est à toi:')
        return choix_type_recommandation

    def _choisi_type_recommandation(self):
        type_recommandation = self._demande_type_recommandation()
        return type_recommandation
